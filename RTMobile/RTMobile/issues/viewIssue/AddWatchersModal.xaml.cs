...
namespace RTMobile.issues.viewIssue
{
    ...
    public partial class AddWatchersModal
    {
        ...
        public List<RTMobile.User> usrs { get; set; }
        public ObservableCollection<RTMobile.User> Additional { get; set; }
        public ObservableCollection<RTMobile.Watches> watchers { get; set; }
        ...
        public void DelFromWatchers(object nameadded)
        {
            ...
            if (Additional.Count != 0)
            {
                ...
                watchers.Remove(new RTMobile.Watches { name = ((RTMobile.User)nameadded).name, displayName = ((RTMobile.User)nameadded).displayName });
        ...
        public void DelWatcher(object sender, EventArgs e)
        { 
